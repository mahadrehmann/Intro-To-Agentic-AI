...
# genai.configure(api_key="AIzaSyDIbZxuNOPneDXxUqsfe5IsH0StV8N-Im4")

# # Choose an appropriate embedding model
# model = "models/text-embedding-004" # Or other suitable embedding model
...
#     task_type="RETRIEVAL_DOCUMENT" # Specify task type if required by the model
# )
